...
// Type definition for Cricket game data
...
export default async function CricketScores() {
  try {
    const apiUrl = process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8080';
    const response = await fetch(`${apiUrl}/api/cricket-results`, {
    ...
    const results: CricketGame[] = games.result || [];
    ...
    return (
      <div className="container mx-auto p-6">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900">Cricket Scores</h1>
          <p className="text-gray-600 mt-2">Latest cricket match results and scores</p>
        </div>
    ...
    console.error('Error in Cricket Scores page:', error);
    
    return (
      <div className="container mx-auto p-6">
        <h1 className="text-3xl font-bold text-gray-900 mb-6">Cricket Scores</h1>
        <Card>
          <CardContent className="p-6 text-center">
            <p className="text-red-500 mb-2">Unable to load Cricket scores</p>
